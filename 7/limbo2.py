def main(items):
    ...
    for condition, result in rules:
        if all(normalized[i] == v for i, v in condition.items()):
            return result
    return -1
